      ...
      BEGIN
         ...
         BEGIN
            ...
            BEGIN
               ...
               IF NOT EXISTS(SELECT * FROM NEMPV WHERE NUMDOC=@NUMDOC AND YEAR(F_INICAL)=YEAR(@FINICIAL) AND YEAR(F_FINAL)=YEAR(DATEADD(YEAR,1,@FINICIAL)))
               BEGIN
                  SELECT @MAX=MAX(ITEM) FROM NEMPV WHERE NUMDOC=@NUMDOC
                  ...
                  SELECT @NUMDOC, @MAX, NULL, DATEADD(YEAR,1,@FECHAING), 15*@NPERIODOS, @FINICIAL, DATEADD(YEAR,1,@FINICIAL), NULL, 'Proceso', 0, 0
               END
