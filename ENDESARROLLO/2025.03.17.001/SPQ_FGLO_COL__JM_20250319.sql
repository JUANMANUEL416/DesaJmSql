...
DECLARE  @PARAMETROS NVARCHAR(MAX)			,@MODELO VARCHAR(100)			   ,@METODO VARCHAR(100)
      ...
      ,@OBSERVACIONRTA  VARCHAR(MAX)      ,@CODRPTA  VARCHAR(20)           ,@RESPUESTA  VARCHAR(20)
      ,@CONCEPTO  VARCHAR(20)             ,@DESCRIPCION  VARCHAR(20)       ,@VLRGLOSA  VARCHAR(20)
...
BEGIN
   ...
   BEGIN   
      ...
      @CODRPTA =CODRPTA,@RESPUESTA =RESPUESTA,@CONCEPTO =CONCEPTO,@DESCRIPCION =DESCRIPCION,@CANTIDAD =CANTIDAD,@VR_UNITARIO =VR_UNITARIO,@IDSERVICIO =IDSERVICIO
      FROM   OPENJSON (@DATOS)
      WITH   (  
      PROCESO  VARCHAR(20)       '$.PROCESO',
      CNSGLO  VARCHAR(20)        '$.CNSGLO',
