...
BEGIN
  ...
  BEGIN
      SELECT @sUrl='https://integradorqa.clinicainternacional.com.pe/FacturacionPaciente/AbonoPacienteEM'
  END
  ELSE
  BEGIN
      SELECT @sUrl='https://integradorqa.clinicainternacional.com.pe/FacturacionGarante/AbonoGaranteEM'
  END
