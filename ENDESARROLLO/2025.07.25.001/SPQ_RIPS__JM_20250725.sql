	...
	BEGIN
      ...
      BEGIN
            ...
            BEGIN
					...
					IF NOT EXISTS (SELECT 1 FROM FNOTJSON WHERE CNSFNOT = @CNSDOC AND CLASE=CASE WHEN @TIPODOC='NC' THEN 'C' ELSE 'D' END)
					BEGIN
						INSERT INTO FNOTJSON (CNSFNOT,CLASE, JSON_ENVIO,JSON_RESPUESTA, CUV, FRADICA_RIPS)
						SELECT @CNSDOC,CASE WHEN @TIPODOC='NC' THEN 'C' ELSE 'D' END, @JsonSolicitud , @JSONRESPUESTA, @CUV, CAST(@FRADICACION AS DATETIME2)
					END
					ELSE
					BEGIN
						UPDATE FNOTJSON 
            ...
            BEGIN              
                  ...
                  PRINT '@ResultadosValidacion >'  + COALESCE(@ResultadosValidacion,' SIN @ResultadosValidacion')
					   ...
					   BEGIN
						   ...
						   SELECT @CNSDOC,CASE WHEN @TIPODOC='NC' THEN 'C' ELSE 'D' END, @JSONRESPUESTA, GETDATE()
					   END
					   ELSE
					   BEGIN
						   UPDATE FNOTJSON 
                  ...
                  AND CLASE=CASE WHEN @TIPODOC='NC' THEN 'C' ELSE 'D' END
					   ...
					   BEGIN
						   INSERT INTO FNOTJSON (CNSFNOT,CLASE,JSON_ENVIO,JSON_RESPUESTA, CUV, FRADICA_RIPS)
						   SELECT @CNSDOC,CLASE=CASE WHEN @TIPODOC='NC' THEN 'C' ELSE 'D' END, @JsonSolicitud , @JSONRESPUESTA, @CUV, GETDATE()
					   END
					   ELSE
					   BEGIN
						   UPDATE FNOTJSON 
