	...
	BEGIN         
		...
		BEGIN
			...
			SELECT @SQL=
						...
						(FTR.VALORSERVICIOS-CASE WHEN COALESCE(VALORCOPAGO,0) >0 THEN  COALESCE(VALORCOPAGO,0) ELSE 0 END) VALORSERVICIOS ,''''F_COMP_REF,''''TIPO_REF,''''NRO_SERIE,'''' NRO_REFERENCIA
