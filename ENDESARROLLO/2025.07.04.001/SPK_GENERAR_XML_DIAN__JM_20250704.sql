                  ...
                  BEGIN -- FEV-RIPS Resol. 1036 de 2022 Las consultas en facturas de procedencia asistencial (archivo AC) 
                     ...
                     BEGIN
                        ...
                        BEGIN                          
                           ...
                           FROM (
                              SELECT VLR_MODE = CASE WHEN EXISTS(SELECT *  FROM MOCCD WHERE TIPODEPAGO='Moderadora' AND FTRD.VLR_COPAGOS=MOCCD.VALOR) AND COALESCE(FTRD.TCOPAGO,'') IN('','02') THEN FTRD.VLR_COPAGOS ELSE 0 END , 
                                     VLR_COPA = CASE WHEN NOT EXISTS(SELECT *  FROM MOCCD WHERE TIPODEPAGO='Moderadora' AND FTRD.VLR_COPAGOS=MOCCD.VALOR) AND COALESCE(FTRD.TCOPAGO,'') IN('','01')  THEN FTRD.VLR_COPAGOS ELSE 0 END
                           ...
                           BEGIN
				                  SET @XML+=@E+@T+@T+@T+@T+@T+@T+@T+@T+'<AdditionalInformation>' 
					               SET @XML+=@E+@T+@T+@T+@T+@T+@T+@T+@T+@T+'<Name>COPAGO</Name>' 
					               SET @XML+=@E+@T+@T+@T+@T+@T+@T+@T+@T+@T+'<Value>'+CAST(COALESCE(@VLR_COPAGOAC,0)+COALESCE(@VLR_COP,0) AS VARCHAR)+'</Value>' 
					               SET @XML+=@E+@T+@T+@T+@T+@T+@T+@T+@T+'</AdditionalInformation>' 
                           END
                           ...
                           BEGIN
				                  SET @XML+=@E+@T+@T+@T+@T+@T+@T+@T+@T+'<AdditionalInformation>' 
					               SET @XML+=@E+@T+@T+@T+@T+@T+@T+@T+@T+@T+'<Name>CUOTA_MODERADORA</Name>' 
					               SET @XML+=@E+@T+@T+@T+@T+@T+@T+@T+@T+@T+'<Value>'+CAST(COALESCE(@VALORMODERADORA,0)+COALESCE(@VLR_MODERAAC,0) AS VARCHAR)+'</Value>' 
					               SET @XML+=@E+@T+@T+@T+@T+@T+@T+@T+@T+'</AdditionalInformation>' 
                           END
                        END
                     END
            ...
            BEGIN         
               ...
               BEGIN
                  ...
                  BEGIN
                     ...
                     SELECT @VLR_COPAGO=(@VLR_COPAGOAC+@VLR_COPAGODETA)+COALESCE(@VALORMODERADORA,0)
