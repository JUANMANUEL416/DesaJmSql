CREATE OR ALTER PROCEDURE DBO.SPK_RIPS_JSON_FTR_CAPIX
...
BEGIN
   ...
   --UPDATE @USUARIOS SET @TIPOUSU='03' WHERE 1=1
    ...
    --OTROS RECIEN NACIDOS
     ...
     END
    --DELETE @USUARIOS  WHERE usuarioId NOT IN(
    --SELECT usuarioId FROM @CONSULTAS
    --UNION 
    --SELECT usuarioId FROM @PROCEDIMIENTOS
    --UNION 
    --SELECT usuarioId FROM @MEDICAMENTOS
    --UNION 
    --SELECT usuarioId FROM @OTROSSER
    --)
