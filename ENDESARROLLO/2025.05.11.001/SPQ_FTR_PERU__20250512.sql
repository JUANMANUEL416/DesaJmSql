...
BEGIN
   ...
   BEGIN         
      ...
      FROM AUTD INNER JOIN AUT ON AUTD.IDAUT=AUT.IDAUT
                INNER JOIN LING ON AUT.NOAUT=LING.NOPRESTACION AND LING.TIPOINGRESO='C'
      ...
      WHERE EXISTS(SELECT * FROM AUTD WHERE AUTD.IDAUT=AUT.IDAUT AND    @N_FACTURA IN(AUTD.N_FACTURA,AUTD.NFACTURA))
      RETURN                 
   END
