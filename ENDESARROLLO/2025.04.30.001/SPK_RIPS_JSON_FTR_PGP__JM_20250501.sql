...
--QUERY2	
    ...
    --OTROS RECIEN NACIDOS
     ...
     UPDATE @CONSULTAS SET vrServicio=0,valorPagoModerador=CASE WHEN @CPROPIO=1 THEN 0 ELSE valorPagoModerador END,conceptoRecaudo=CASE WHEN @CPROPIO=1 OR valorPagoModerador =0 THEN '05' ELSE CASE WHEN  valorPagoModerador IN (SELECT VALOR FROM @MODERADORAS) THEN '02' ELSE '01' END END WHERE 1=1
     UPDATE @PROCEDIMIENTOS SET vrServicio=0 ,valorPagoModerador=CASE WHEN @CPROPIO=1 THEN 0 ELSE valorPagoModerador END,conceptoRecaudo=CASE WHEN @CPROPIO=1 OR valorPagoModerador =0 THEN '05' ELSE CASE WHEN  valorPagoModerador IN (SELECT VALOR FROM @MODERADORAS) THEN '02' ELSE '01' END END WHERE 1=1
     UPDATE @MEDICAMENTOS SET vrServicio=0,vrUnitMedicamento=0,valorPagoModerador=CASE WHEN @CPROPIO=1 THEN 0 ELSE valorPagoModerador END,conceptoRecaudo=CASE WHEN @CPROPIO=1 OR valorPagoModerador =0 THEN '05' ELSE CASE WHEN  valorPagoModerador IN (SELECT VALOR FROM @MODERADORAS) THEN '02' ELSE '01' END END  WHERE 1=1
     UPDATE @OTROSSER SET vrServicio=0,vrUnitOS=0,valorPagoModerador=CASE WHEN @CPROPIO=1 THEN 0 ELSE valorPagoModerador END,conceptoRecaudo=CASE WHEN @CPROPIO=1 OR valorPagoModerador =0 THEN '05' ELSE CASE WHEN  valorPagoModerador IN (SELECT VALOR FROM @MODERADORAS) THEN '02' ELSE '01' END END  WHERE 1=1
