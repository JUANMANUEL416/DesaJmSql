...
--query2
   ...
   BEGIN
      ...
      BEGIN
         ...
         UPDATE @CONSULTAS SET vrServicio=vrServicio+ABS(@VALORCOPAGO-@VALORCOPAGOACU)   WHERE CONSECUTIVO=@CONSE 
      END
      ELSE
      BEGIN
         ...
         if COALESCE(@CONSE,0)>0
         BEGIN
            UPDATE @PROCEDIMIENTOS SET vrServicio=vrServicio+ABS(@VALORCOPAGO-@VALORCOPAGOACU)   WHERE CONSECUTIVO=@CONSE 
         END
         ELSE
         BEGIN
            ...
            if COALESCE(@CONSE,0)>0
            BEGIN
               UPDATE @MEDICAMENTOS SET vrServicio=vrServicio+ABS(@VALORCOPAGO-@VALORCOPAGOACU)   WHERE CONSECUTIVO=@CONSE 
            END   
            ELSE
            BEGIN
               ...
               if COALESCE(@CONSE,0)>0
               BEGIN
                  UPDATE @OTROSSER SET vrServicio=vrServicio+ABS(@VALORCOPAGO-@VALORCOPAGOACU)   WHERE CONSECUTIVO=@CONSE 
               END  
            END
         END
      END
