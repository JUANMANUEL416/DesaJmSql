		...
		BEGIN -- Detalles de la Factura
			...
			BEGIN
				...
				BEGIN
					...
					BEGIN
						UPDATE #FTRD SET MED=1, REFERENCIA=CASE COALESCE(D.CODIGOCUM,'') WHEN '' THEN CASE COALESCE(IART.CODCUM,'') WHEN '' THEN SER.CODCUM ELSE IART.CODCUM END ELSE D.CODIGOCUM END
						FROM #FTRD A 
