IF EXISTS(SELECT NAME FROM SYSOBJECTS WHERE NAME='SPK_NC_CONTAB_FNOT' AND XTYPE='P')
BEGIN
   DROP PROCEDURE SPK_NC_CONTAB_FNOT
END

GO
CREATE  PROCEDURE DBO.SPK_NC_CONTAB_FNOT
@CNSFNOT          VARCHAR(20), 
@CLASE            VARCHAR(1),
@USUARIO          VARCHAR(12),
...
BEGIN
   ...
   @ESANULACION=CASE WHEN COALESCE(@ESANULACION,0)=0 THEN CASE WHEN FNOT.VR_TOTAL>=FTR.VR_TOTAL THEN 1 ELSE 0 END ELSE @ESANULACION END-- VALIDA ANULACION TOTAL
