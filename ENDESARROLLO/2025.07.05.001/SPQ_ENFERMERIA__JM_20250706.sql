	...
	BEGIN
		...
		BEGIN
			...
			SELECT Z.CNS, Z.IDTERCERO, Z.ID1, Z.TIPO, Z.ID2, Z.ID3, Z.STRINGMEDIO2, Z.FECHA1, Z.CANTIDAD, Z.NOMBRE, Z.STRINGMEDIO1, HADM.FECHA, HADM.IDAFILIADO, 
				CASE HADM.ESTADO WHEN 0 THEN 'Admitido' when 1 then 'Alta Administrativa' when 2 then 'Alta medica' when 3 then 'Alta de enfermeria' else 'Error al validar estado' END ESTADO 
