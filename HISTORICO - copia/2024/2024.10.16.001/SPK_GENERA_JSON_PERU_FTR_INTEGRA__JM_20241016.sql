IF EXISTS (SELECT NAME FROM SYSOBJECTS WHERE NAME = 'SPK_GENERA_JSON_PERU_FTR_INTEGRA' AND TYPE = 'P')
BEGIN
   DROP PROCEDURE SPK_GENERA_JSON_PERU_FTR_INTEGRA
END
GO
CREATE PROCEDURE DBO.SPK_GENERA_JSON_PERU_FTR_INTEGRA 
      ...
      ORDER BY N_CUOTA ASC
	   ...
	   BEGIN 
         SELECT @ITEM=CONVERT(varchar(3),N_CUOTA),@CANTIDAD=CONVERT(varchar(4),CONVERT(INT,CEILING(FTRD.CANTIDAD))),
                ...
                @VALOR2=CONVERT(VARCHAR(20),CONVERT(DECIMAL(14,4),COALESCE(VLR_SERVICI,0))),
