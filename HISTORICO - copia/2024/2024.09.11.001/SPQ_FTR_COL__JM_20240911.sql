...
DECLARE  @PARAMETROS NVARCHAR(MAX)			,@MODELO VARCHAR(100)			   ,@METODO VARCHAR(100)
   ...
   BEGIN
      ...
      BEGIN
         ...
         BEGIN TRY 
            ...
            CASE WHEN @IXCOUNTRY='PERU' THEN @VALOR/1.18  ELSE  @VALOR  END ,
            @VR_TOTAL,@VR_TOTAL,@IDPLAN,@CCOSTO,@N_FACTURA,dbo.FNK_GETDATE(),COALESCE(@VLR_CPROPIOFRD,0),
            CASE WHEN @IXCOUNTRY='PERU' THEN @VALOR-(@VALOR/1.18)  ELSE  NULL  END ,
   ...
   BEGIN 
      ...
      BEGIN
         ...
         RETURN
      END
      IF @IXCOUNTRY='PERU' AND EXISTS(SELECT * FROM FTR WHERE N_FACTURA=@N_FACTURA AND COALESCE(FACTEP,'')<>'OK')
      BEGIN
