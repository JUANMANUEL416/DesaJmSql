IF EXISTS(SELECT NAME FROM SYSOBJECTS WHERE NAME= 'VWK_ESTADODIAN_FTRE' AND TYPE='V')
BEGIN
 DROP VIEW VWK_ESTADODIAN_FTRE
END
GO
CREATE VIEW DBO.VWK_ESTADODIAN_FTRE
AS
...
CASE WHEN COALESCE(FTRE.NOTIFICADO,0) =1 THEN 'Enviada' ELSE 'SinEnviar' END NOTICLIENTE,FTR.F_FACTURA AS FECHADOC,FTR.USUARIOFACTURA
...
CASE WHEN COALESCE(FTRE.NOTIFICADO,0) =1 THEN 'Enviada' ELSE 'SinEnviar' END NOTICLIENTE,FNOT.F_NOTA AS FECHADOC,FNOT.USUARIO
