      ...
      END
		...
		END     
         ...
         WHERE 1=1
			...
			SELECT @CNSFTR, N_CUOTA, FECHA, DB_CR, AREAPRESTACION, UBICACION, VR_TOTAL+COALESCE(VIVA,0),
				IMPUTACION, CCOSTO, PREFIJO, ANEXO, REFERENCIA, IDCIRUGIA, CANTIDAD,
				VALOR, VLR_SERVICI+COALESCE(VIVA,0), VLR_COPAGOS, VLR_PAGCOMP, IDPROVEEDOR, NOADMISION,
