...
BEGIN  
   ...
   BEGIN
      ...
      BEGIN
         SELECT COALESCE(SED.DESCRIPCION,TER.RAZONSOCIAL)RAZONSOCIAL,TER.NIT,COALESCE(SED.DIRECCION,TER.DIRECCION)DIRECCION,COALESCE(SED.TELEFONOS,TER.TELEFONOS)TELEFONOS,
