...
BEGIN
      ...
      BEGIN
         ...
         BEGIN
            BEGIN TRY 
               ...
               SELECT @CNSENTREGA, @PROCESO, @USUARIO, DBO.FNK_GETDATE(), NULL, @USUARIO, '01', 0, CASE WHEN @PROCESO='FACTURAS' THEN  DBO.FNK_VALORVARIABLE('IDFDEPFACTURACION') ELSE  DBO.FNK_VALORVARIABLE('IDFDEPCARTERA') END,
               CASE WHEN @PROCESO='FACTURAS' THEN  DBO.FNK_VALORVARIABLE('IDFDEPCARTERA') ELSE  DBO.FNK_VALORVARIABLE('IDFDEPFACTURACION') END, NULL, @IDSEDE, NULL, NULL, NULL, @REQSEDE
   ...
   BEGIN 
      ...
      BEGIN
         IF EXISTS(SELECT * FROM ENT WHERE CNSENTREGA=@CNSENTREGA AND COALESCE(CERRADO,0)=0 AND COALESCE(ESTADO,0)=0 
                   AND  ENT_ENTREGA=CASE WHEN PROCESO='FACTURAS' THEN DBO.FNK_VALORVARIABLE('IDFDEPFACTURACION') 
                                    ELSE DBO.FNK_VALORVARIABLE('IDFDEPCARTERA') END  
                   AND ENT_RECIBE=CASE WHEN PROCESO='FACTURAS' THEN DBO.FNK_VALORVARIABLE('IDFDEPCARTERA')  
                                   ELSE  DBO.FNK_VALORVARIABLE('IDFDEPFACTURACION') END)
         BEGIN
            SELECT @SYS_COMPUTERNAME=COALESCE(SYS_COMPUTERNAME,HOST_NAME()) FROM USUSU WHERE USUARIO=@USUARIO
            IF @PROCESO='FACTURAS'
            BEGIN
   ...
   BEGIN 
      ...
      IF EXISTS(SELECT * FROM ENT WHERE CNSENTREGA=@CNSENTREGA AND ENT_ENTREGA=CASE WHEN PROCESO='FACTURAS' THEN DBO.FNK_VALORVARIABLE('IDFDEPFACTURACION') ELSE DBO.FNK_VALORVARIABLE('IDFDEPCARTERA') END  AND ENT_RECIBE=CASE WHEN PROCESO='FACTURAS' THEN DBO.FNK_VALORVARIABLE('IDFDEPCARTERA')  ELSE  DBO.FNK_VALORVARIABLE('IDFDEPFACTURACION') END)
      BEGIN
