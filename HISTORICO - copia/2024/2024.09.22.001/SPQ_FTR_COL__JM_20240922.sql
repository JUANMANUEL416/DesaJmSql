   ...
   BEGIN         
      ...
      BEGIN
         BEGIN TRY  
            ...
            INSERT INTO HADM(NOADMISION,FECHA,IDSEDE,IDTERCERO,IDPLAN,CLASEING,CERRADA,USUARIO,OBS,TIPODTO,DESCUENTO)
            SELECT @NOADMISION,DBO.FNK_GETDATE(),@IDSEDEF,@IDTERCERO,DBO.FNK_VALORVARIABLE('IDPLANPART'),'C',0,@USUARIO,@OBSERVACION,'N',0
         END TRY
         BEGIN CATCH
                 INSERT INTO @TBLERRORES(ERROR) SELECT ERROR_MESSAGE()
         END CATCH
