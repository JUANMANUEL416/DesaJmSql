   ...
   SELECT @FIMPRESION= CAST(DAY(GETDATE())AS VARCHAR(2))+' de '+
      ...
      BEGIN
         ...
         BEGIN
            ...
            SELECT 'OK'OK,FTR.N_FACTURA,TER.NIT,TER.DV,TER.RAZONSOCIAL,TER.IDALTERNA2,TRIM(TER.DIRECCION) DIRECCION,COALESCE(TER.TELEFONOS,'')TELEFONOS,
                   ...
                   @VLLETRAS+' PESOS M/CTE. ' AS LETRAS,
                  --dbo.FNK_MontoEscrito(FTR.VR_TOTAL)LETRAS,
                   ...
                   COALESCE(FTR.CUFE,'')CUFE,REPLACE(REPLACE(LTRIM(RTRIM(COALESCE(DBO.FNK_RTF(FDIAN.TITULO),''))),CHAR(13),''),CHAR(10),'')RESOL,
                   ...
                   'Forma de Pago:'+CASE WHEN COALESCE(TER.ENVIODICAJA,0)=1 THEN 'Contado' ELSE 'Credito '+CAST(COALESCE(PPT.DIASVTO,30) AS VARCHAR(4))+' Dias' END FPAGO,
      ...
      BEGIN
         ...
         BEGIN
            ...
            SELECT 'OK'OK,FTR.N_FACTURA,TER.NIT,TER.DV,TER.RAZONSOCIAL,TER.IDALTERNA2,TER.DIRECCION,TER.TELEFONOS,TER.EMAIL,CIU.NOMBRE,
                   ...
                   CASE WHEN EXISTS(SELECT DICOM FROM ARCHIVOS WHERE ID = USUSU.IDFIRMA ) 
					...
					, USUSU.USUARIO USUARIOFACTURA,USUSU.NOMBRE AS NUSUFACTURA
            FROM FTR INNER JOIN TER ON FTR.IDTERCERO=TER.IDTERCERO
                     INNER JOIN PLN ON FTR.IDPLAN=PLN.IDPLAN
                     LEFT  JOIN CIU ON TER.CIUDAD=CIU.CIUDAD
                     LEFT  JOIN PPT ON FTR.IDTERCERO=PPT.IDTERCERO AND FTR.IDPLAN=PPT.IDPLAN
