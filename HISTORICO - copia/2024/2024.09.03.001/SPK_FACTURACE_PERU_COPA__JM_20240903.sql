	...
	BEGIN  
		...
		BEGIN
         ...
         CASE COALESCE(@VENTAPRT,0) WHEN 1 THEN VALORTOTAL ELSE VALORCOPAGO END, 
				...
				COALESCE(CIT.CANTIDADC,1) CANTIDAD,CASE COALESCE(@VENTAPRT,0) WHEN 1 THEN VALORTOTAL ELSE VALORCOPAGO END,
            CASE COALESCE(@VENTAPRT,0) WHEN 1 THEN VALORTOTAL ELSE VALORCOPAGO END,0,
				...
				@NVOCONSEC, CIT.SUBCCOSTO, CIT.VALORTOTALCOS, CIT.FECHA, CIT.IDPLAN,
						...
						CASE WHEN COALESCE(SER.IVA,'')='SER' THEN (CASE COALESCE(@VENTAPRT,0) WHEN 1 THEN VALORTOTAL ELSE VALORCOPAGO END * 0.18) ELSE NULL END,
      ...
      END
		...
		END     
         ...
         WHERE 1=1
			...
			SELECT @CNSFTR, N_CUOTA, FECHA, DB_CR, AREAPRESTACION, UBICACION, ROUND(VR_TOTAL+COALESCE(VIVA,0),2),
				IMPUTACION, CCOSTO, PREFIJO, ANEXO, REFERENCIA, IDCIRUGIA, CANTIDAD,
				VALOR,ROUND(VLR_SERVICI+COALESCE(VIVA,0),2), VLR_COPAGOS, VLR_PAGCOMP, IDPROVEEDOR, NOADMISION,
