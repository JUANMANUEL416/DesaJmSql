IF EXISTS (SELECT NAME FROM SYSOBJECTS WHERE NAME = 'SPK_NC_CONTAB_CIERRE_CAJ' AND TYPE = 'P')
BEGIN
   DROP PROCEDURE SPK_NC_CONTAB_CIERRE_CAJ
END
GO
CREATE PROCEDURE DBO.SPK_NC_CONTAB_CIERRE_CAJ 
@CNSACJ VARCHAR(20),
@IDSEDE VARCHAR(20),
