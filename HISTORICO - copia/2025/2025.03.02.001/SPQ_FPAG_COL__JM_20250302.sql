...
BEGIN
   ...
   BEGIN         
      ...
      BEGIN
         ...
         BEGIN
            ...
            FPAG.FECHAPAGO,BANCODOC,FPAG.CODCAJA,FPAG.CNSFACJ,FPAG.VLRGLOSAS,FPAG.VLRIMPUESTOS,FPAG.VLRAJUSTEPESO,FPAG.VLRDTOFINAN,
   ...
   END  
	...
	BEGIN
      ...
      BEGIN TRY           
			...
			VALUES (@CNSFPAG, @FECHAPAGO, @IDTERCERO, @BANCO, @NUMERODOCUMENTO, @VALORPAGO, 0, @USUARIO, @VLRAJUSTEPESO, 
					@VLRAJUSTEPESO, @DTOFNCIERO, 0, @INGRESO, @SUCURSAL, @CTA_BCO, @ITEM, @RENGLON, @NOCONTABILIZA, @FECHA, 
      ...
      BEGIN
         ...
         BEGIN TRY           
			   UPDATE FPAG SET  FECHAPAGO=@FECHAPAGO, IDTERCERO=@IDTERCERO, BANCO=@BANCO, NUMERODOCUMENTO=@NUMERODOCUMENTO, VALORPAGO=@VALORPAGO,
                             ...
                             SUCURSAL=@SUCURSAL, CTA_BCO=@CTA_BCO, ITEM=@ITEM, RENGLON=@RENGLON, NOCONTABILIZA=@NOCONTABILIZA, FECHA=@FECHA, 
	...
	BEGIN
      ...
      SELECT @FECHAPAGO=FECHAPAGO FROM FPAG WHERE CNSFPAG=@CNSFPAG
   ...
   BEGIN 
      ...
      BEGIN
         ...
         BEGIN TRY           
            ...
            SELECT  @CNSRPDX,@N_FACTURA,@TIPOF,@CNSCXC,@USUARIO,@VRL_PAGO,@VRL_PAGO,0,0,0,@VLR_IMP,0,0,@CNSGLO,0,0,@VALORSERVICIOS,@OBSERVACIONES,
      ...
      BEGIN
         ...
         BEGIN TRY           
            INSERT INTO RPDX(CNS,CNS1,GRUPOETAREO,CNS2,ID10,VALOR1,VALOR30,VALOR2,CANTIDAD1,CANTIDAD3,VALOR11,VALOR7,VALOR9,CNS5,CANTIDAD,CANTIDAD2,
                             VALOR10,STRINGMAX,ID11,ID12)
            SELECT  @CNSRPDX,@N_FACTURA,@TIPOF,@CNSCXC,@USUARIO,@SaldoNeto,@SaldoNeto,@VRL_PAGO,1,0,0,0,0,@CNSGLO,0,0,@VALORSERVICIOS,@OBSERVACIONES,
                    @MOTIVO_GLOSA01,@MOTIVO_GLOSA02
         END TRY
         BEGIN CATCH
                 INSERT INTO @TBLERRORES(ERROR) SELECT ERROR_MESSAGE()
