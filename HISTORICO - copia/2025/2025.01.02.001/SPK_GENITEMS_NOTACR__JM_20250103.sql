IF EXISTS (SELECT * FROM sysobjects  WHERE name = 'SPK_GENITEMS_NOTACR' AND type = 'P')
BEGIN
   ...
   BEGIN
      ...
      BEGIN
         ...
         PRINT 'INGRESO LOS ITEMS  DEL PAQUETE Y LOS QUE ESTAN POR FUERA'
		   ...
		   INSERT INTO FNOTD( CNSFNOT, CLASE, ITEM, TIPO, IDSERVICIO, DESCRIPCION, CANTIDAD, VR_UNITARIO,
	 	   ...
	 	   (COALESCE(VLR_SERVICI,0))* (@VLRAREBAJAR_P/100), 
	 		 ROUND((COALESCE(VLR_SERVICI,0))* (@VLRAREBAJAR_P/100),2), '01', @USUARIO, NULL, N_CUOTA, PIVA, VIVA, @N_FACTURA,CCOSTO,AREAPRESTACION,PREFIJO,CUENTACR
	  	   FROM   FTRD 
		   WHERE  N_FACTURA   = @N_FACTURA
      ...
      END
	   ...
	   BEGIN
		   INSERT INTO FNOTD( CNSFNOT, CLASE, ITEM, TIPO, IDSERVICIO, DESCRIPCION, CANTIDAD, VR_UNITARIO,
	 						 VR_TOTAL, COMPANIA, USUARIO, OBSERVACION, N_CUOTA, PIVA, VALORIVA, N_FACTURA,CCOSTO,IDAREA,PREFIJO,CUENTA)
	 	   SELECT @CNSFNOT, 'C', N_CUOTA, 'S', LEFT(REFERENCIA,20),left (ANEXO,512), 1,(COALESCE(VLR_SERVICI,0)* (@VLRAREBAJAR_P/100)), 
	 		 ROUND(COALESCE(VLR_SERVICI,0)*(@VLRAREBAJAR_P/100),2), '01', @USUARIO, NULL, N_CUOTA, PIVA, VIVA, @N_FACTURA,
