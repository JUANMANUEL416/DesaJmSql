...
BEGIN
   ...
   BEGIN
      ...
      BEGIN
         ...
         (COALESCE(VLR_SERVICI,0)-(CASE WHEN DBO.FNK_VALORVARIABLE('IXCOUNTRY')='PERU'  AND COALESCE(VLR_COPAGOS,0)>0 THEN VLR_COPAGOS ELSE 0 END) * (@VLRAREBAJAR_P/100)), 
	 		 ROUND(COALESCE(VLR_SERVICI,0)-(CASE WHEN DBO.FNK_VALORVARIABLE('IXCOUNTRY')='PERU'  AND COALESCE(VLR_COPAGOS,0)>0 THEN VLR_COPAGOS ELSE 0 END) *(@VLRAREBAJAR_P/100),2),
