   ...
   BEGIN         
      ...
      BEGIN
         ...
         SELECT @SQL=
            ...
            ' +@PART+ '
            UNION ALL 
            SELECT PLN.DESCPLAN,DBO.FNK_FECHA_GRINGA(FNOT.F_NOTA)F_NOTA,DBO.FNK_FECHA_GRINGA(FNOT.F_NOTA)F_NOTA,CASE FTR.TIPOFIN WHEN ''N'' THEN IIF(FNOT.CLASE=''C'',''NCB'',''NDB'') WHEN ''C'' THEN IIF(FNOT.CLASE=''C'',''NCF'',''NDF'') END TIPO,
