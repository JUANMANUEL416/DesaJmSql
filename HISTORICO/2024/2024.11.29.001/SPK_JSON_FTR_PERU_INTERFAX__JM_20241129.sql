...
BEGIN  
   ...
   SELECT @JSON=@JSON+'"CO_SOCIEDAD_SAP": "CI10",'   
 ...
 --PRINT @JSON
  ...
  BEGIN
      SELECT @sUrl='/FacturacionPaciente/PreFacturaPacienteEM'
  END
  ELSE
  BEGIN
      SELECT @sUrl='/FacturacionGarante/PreFacturaGaranteEM'
  END
  ...
  BEGIN
     ...
     END
     UPDATE FTR SET FACTEP='104',ULRPTAAPI=@response WHERE N_FACTURA=@N_FACTURA
