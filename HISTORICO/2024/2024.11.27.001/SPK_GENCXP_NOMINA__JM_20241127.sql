...
BEGIN
   ...
   BEGIN
     ...
     SELECT @MANEXO = 0
     IF EXISTS(SELECT * FROM TER WHERE IDTERCERO=@IDTERCERO_CUR AND COALESCE(MANEXO,0)=1)
     BEGIN
        SELECT @MANEXO=1
     END
     ...
     INSERT INTO FCXP (CNSFCXP,FECHA,CNSFCOM,IDTERCERO,NOREFERENCIA,F_FACTURAREF,F_VENCE,VALOR,ESTADO,F_CANCELADO,USUARIO,
                        ...
                        VLR_NOTASDEBITO,VLR_COMISION,CUEDEBITO,CUECREDITO,CNSFCXPPM,TIPOCXP,CNSPPTO,CNSCDP,CNSRP,DOCEQUIVALENTE)
