...
BEGIN
	...
	DECLARE PG_CURSOR CURSOR FOR 
		...
		AND 1=CASE WHEN @IDKAPAGE IS NOT NULL THEN 1 ELSE CASE WHEN ESTADO IN('SEND','RUNNING','REFUSED') THEN 1 ELSE CASE WHEN COALESCE(REF_PAGO,'')='' THEN 1 ELSE 0 END END END
		ORDER BY IDKPAGE
	OPEN PG_CURSOR    
