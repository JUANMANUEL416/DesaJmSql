IF EXISTS(SELECT NAME FROM SYSOBJECTS WHERE NAME= 'SPK_ADDSERCAP' AND TYPE='P')
BEGIN
   DROP PROCEDURE SPK_ADDSERCAP
END

GO
CREATE PROCEDURE DBO.SPK_ADDSERCAP  
    @CNSFTR      VARCHAR(20),  
    @N_CUOTA     INT,  
...
BEGIN  
    ...
    PRINT 'Asignando Servicios a la Factura No. '+@N_FACTURA  
