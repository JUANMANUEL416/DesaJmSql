...
DECLARE   @CODCAJERO    VARCHAR(20)    ,@CNSFACJ   VARCHAR(20)       ,@CONCEPTO VARCHAR(30)     ,@CAUSA  VARCHAR(200)
...
--query 3
	...
	BEGIN
		...
		SELECT  --Se cambio el Select a pedido del Sr. Sander 2023-02-07 (select brindado por el) CLASEORDEN  TIPOCITA FECHASOL
			...
			CASE WHEN CIT.CONFIRMADA = 1 THEN 'Cita Conf.' ELSE 'Cita NO Conf' end CITA_CONFIRMADA, 
	...
	BEGIN
		...
		SELECT 'OK' OK
		SELECT NOMBRE FROM MED WHERE IDMEDICO = @IDMEDICO
		RETURN
	END
