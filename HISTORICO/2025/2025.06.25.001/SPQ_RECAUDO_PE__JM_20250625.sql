...
DECLARE @MONEDA VARCHAR(20), @DATO3 VARCHAR(20), @DESCUENTO DECIMAL(14,2), @CUENTACXC VARCHAR(16), @IDTERPART VARCHAR(20), @VENTAPRT     BIT=0
				...
				, @MOVILAFI VARCHAR(13)	,@PACIENTE VARCHAR(500)	, @SMS VARCHAR(8000)	,@VALOR_TEXTO VARCHAR(20)	, @CELULAR VARCHAR(20)	,@NOM_PREFIJO VARCHAR(150),@IDPROVEEDOR VARCHAR(20)
	...
	/* VALIDACIONES DE CAJA */
		...
		BEGIN TRY
			...
			BEGIN
				...
				INNER JOIN FCJ ON CIT.CONSECUTIVO = FCJ.NOADMISION AND FCJ.PROCEDENCIA = 'CITAS'
            ...
            PRINT @PROCESO
               ...
               PRINT 'ANTES DE ENVIAR'
					...
					BEGIN
						...
						PRINT 'ENTRA A ENVIAR POR CORREO ====>>>>>>>>>>>'
