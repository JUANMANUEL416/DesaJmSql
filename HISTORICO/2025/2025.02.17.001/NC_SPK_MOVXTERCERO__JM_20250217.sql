...
BEGIN
   ...
   CREATE TABLE #TABLA_FNK_MOVXTERCERO
      (TIPO          SMALLINT UNIQUE (TIPO, ITEM), 
       ...
       REFERENCIA1		 VARCHAR(20) COLLATE database_default, 
       REFERENCIA2		 VARCHAR(20) COLLATE database_default, 
       REFERENCIA3		 VARCHAR(20) COLLATE database_default,
   ...
   INSERT INTO #TABLA_FNK_MOVXTERCERO (TIPO, IDTERCERO, CUENTA, CCOSTO, N_FACTURA, DETALLE, COMPROBANTE, NOREFERENCIA, NROCOMPROBANTE, 
                                       FECHAMOV, FECHAINI, FECHAFIN, SI, DB, CR, SF, CODUNG, CODPRG, NOCHEQUE,REFERENCIA1,REFERENCIA2,REFERENCIA3)
   SELECT 2, IDTERCERO=COALESCE(MCH.IDTERCERO,''), CUENTA=MCH.CUENTA, 
          ...
          MCH.REFERENCIA1,MCH.REFERENCIA2,MCH.REFERENCIA3
...
-- PRINT 'ANTES DEL UPDATE(*3)'
   ...
   SET @QUERYFINAL =  'INSERT INTO RPDX2 (CNS, VALOR10, ID1, STRINGMEDIO1, ID2, STRINGMEDIO2, ID3, STRINGMEDIO3, VALOR1, VALOR2, VALOR3, VALOR4, FECHA1, FECHA2, ID4, FECHA3, STRINGGRANDE1, ID5, ID6, ID7, ID8, ID9, ID10,ID11,ID12,ID13) '+
   ...
   '(CASE WHEN ESTADO = ''A'' THEN 0 ELSE CR END) CR, (CASE WHEN ESTADO = ''A'' THEN 0 ELSE SF END) SF, FECHAINI, FECHAFIN, N_FACTURA, FECHAMOV, DETALLE, COMPROBANTE, NOREFERENCIA, CODUNG, CODPRG, NOCHEQUE, ESTADO, REFERENCIA1, REFERENCIA2, REFERENCIA3 ' +
