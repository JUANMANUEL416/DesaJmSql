...
BEGIN
   ...
   SELECT @PROCEDENCIA=PROCEDENCIA,@COPAPROPIO=COPAPROPIO,@VLR_COPAGOF=CP_VLR_COPAGOS 
	   ...
	   BEGIN
         ...
         BEGIN
            ...
            BEGIN
               PRINT 'ENCONTRE UNO'
               DECLARE @NOITEM INT
               SELECT  TOP 1  @NOITEM=ITEM FROM FNOTD WHERE CNSFNOT=@CNSFNOT AND VR_UNITARIO>=@VLR_COPAGOF
