         ...
         END
			...
			BEGIN TRY
				...
				INSERT INTO FTR(CNSFCT, COMPANIA, CLASE, IDTERCERO, N_FACTURA, F_FACTURA, F_VENCE, VR_TOTAL, COBRADOR, VENDEDOR, MONEDA, OCOMPRA, ESTADO, F_CANCELADO,
                        ...
                        CP_MODALIDAD,CP_MES,FECHACAP_INI,FECHACAP_FIN, VALORMODERADORA,SINCNT,CUOTAS,TIPOCAP)
...
--QUERY 3
         ...
         BEGIN
            ...
            BEGIN
               PRINT 'VOY POR PGP'
				   ...
				   SELECT 'OK' OK,@XML AS XML_FACTURA, @NOMBREXML AS NOMBRE_XML,@RIPSJSON AS RIPSJSON,@NOMBREJSON AS NOMBREJSON, CAST(0 AS BIT) AS ISCAPITA
            END 
            ELSE
            BEGIN
               ...
               BEGIN
                  PRINT 'Capita Normal'
				      ...
				      SELECT 'OK' OK,@XML AS XML_FACTURA, @NOMBREXML AS NOMBRE_XML,@RIPSJSON AS RIPSJSON,@NOMBREJSON AS NOMBREJSON, CAST(@CAPITA AS BIT) AS ISCAPITA,@TIPOCAP AS TIPOCAP
               END
               IF COALESCE(@TIPOCAP,0)=4
               BEGIN
         ...
         END
            ...
            BEGIN
               PRINT'VOY POR MASIVA'
				   ...
				   SELECT 'OK' OK,@XML AS XML_FACTURA, @NOMBREXML AS NOMBRE_XML,@RIPSJSON AS RIPSJSON,@NOMBREJSON AS NOMBREJSON, CAST(@CAPITA AS BIT) AS ISCAPITA
				   RETURN
            END
			ELSE
			BEGIN
	...
	BEGIN         
		BEGIN TRY 
			DECLARE @WHERE_DATA VARCHAR(500) = JSON_VALUE(@PARAMETROS, '$.WHERE_DATA')
