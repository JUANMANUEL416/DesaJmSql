CREATE OR ALTER PROCEDURE DBO.SPK_GENERA_ORDENPAGO_IZIPAY @NOADMISION VARCHAR(20)
	,@TABLA VARCHAR(20)
...
BEGIN
	...
	IF COALESCE(@WOMPI_INTEGRITY_KEY, '') <> ''
	BEGIN
		...
		SELECT @PASARELA = 'WOMPI'

		RAISERROR('Pasarela Wompi POR DEFINIR', 16, 1)
	...
	EXEC sys.sp_OACreate 'MSXML2.ServerXMLHttp'
		,@obj OUT

	EXEC sys.sp_OAMethod @obj
		,'Open'
		,NULL
		,'POST'
		,@sUrl
